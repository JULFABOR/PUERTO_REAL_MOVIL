    ...
    <View style={styles.modalOverlay}>
      <View style={styles.modalContainer}>
        <View style={styles.modalHeader}>
          <Text style={styles.modalTitleText}>{isEdit ? t('suppliers.editSupplier') : t('suppliers.addSupplier')}</Text>
        ...
        <ScrollView style={styles.modalBody}>
          ...
          <TextInput style={styles.formInput} placeholder={t('suppliers.companyNamePlaceholder')} value={name} onChangeText={setName} />
          
          <Text style={styles.formLabel}>{t('suppliers.contactPerson')}</Text>
          <TextInput style={styles.formInput} placeholder={t('suppliers.contactPersonPlaceholder')} value={contactPerson} onChangeText={setContactPerson} />

          <Text style={styles.formLabel}>{t('suppliers.phone')}</Text>
          <TextInput style={styles.formInput} placeholder={t('suppliers.phonePlaceholder')} value={phone} onChangeText={setPhone} keyboardType="phone-pad" />

          <Text style={styles.formLabel}>{t('suppliers.email')}</Text>
          <TextInput style={styles.formInput} placeholder={t('suppliers.emailPlaceholder')} value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" />
        </ScrollView>
        <TouchableOpacity style={styles.primaryButton} onPress={handleSave}>
          <FontAwesome name={isEdit ? 'save' : 'plus'} size={20} color="#fff" />
          <Text style={styles.primaryButtonText}>{isEdit ? t('suppliers.saveChanges') : t('suppliers.addSupplier')}</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
        ...
        <View style={styles.overlay}>
          ...
          <View style={styles.controlsContainer}>
            <View style={styles.searchContainer}>
              ...
              <TextInput style={styles.searchInput} placeholder={t('suppliers.search')} placeholderTextColor={DARK_GREY} value={searchQuery} onChangeText={setSearchQuery} />
            </View>
            <TouchableOpacity style={styles.addButton} onPress={() => setIsAddModalVisible(true)}><FontAwesome name="plus" size={20} color="#fff" /><Text style={styles.addButtonText}>{t('suppliers.add')}</Text></TouchableOpacity>
          </View>
          ...
          <View style={styles.modalContainer}>
            ...
            <View style={styles.modalBody}>
              ...
              <View style={styles.buttonContainer}>
                <TouchableOpacity style={[styles.button, styles.cancelButton]} onPress={() => setIsDeleteModalVisible(false)}><Text style={[styles.buttonText, {color: DARK_GREY}]}>{t('suppliers.cancel')}</Text></TouchableOpacity>
