          ...
          >
            <View style={styles.modalContainer}>
              <View style={styles.modalContent}>
                <Text style={styles.modalTitle}>{selectedProduct ? t('stock.modal_title_edit') : t('stock.modal_title_add')}</Text>
                <TextInput placeholder={t('stock.product_name_placeholder')} value={productName} onChangeText={setProductName} style={styles.input} />
                <TextInput placeholder={t('stock.category_placeholder')} value={productCategory} onChangeText={setProductCategory} style={styles.input} />
                <TextInput placeholder={t('stock.quantity_placeholder')} value={productStock} onChangeText={setProductStock} style={styles.input} keyboardType="numeric" />
                <TextInput placeholder={t('stock.price_placeholder')} value={productPrice} onChangeText={setProductPrice} style={styles.input} keyboardType="decimal-pad" />
                <View style={styles.modalButtons}>
                    <Button title={t('stock.save_button')} onPress={handleSaveProduct} color={TERRACOTTA} />
                    <Button title={t('stock.cancel_button')} onPress={() => setModalVisible(false)} color="#888" />
                </View>
              </View>
            </View>
          </Modal>
    ...
    <View style={styles.itemContainer}>
      <View style={styles.itemDetails}>
        ...
        <View style={styles.itemStockInfo}>
          <Text style={styles.itemStock}>{t('stock.stock_label', { stock: item.stock })}</Text>
          <Text style={styles.itemPrice}>{t('stock.price_label', { price: (item.price || 0).toFixed(2) })}</Text>
        </View>
      </View>
